	...
	<div class="row">
        <div class="col-md-12">
            <div class="card shadow-sm">
                <div class="card-header bg-light shadow-sm">Colores</div>

                <div class="card-body">

                	<div class="row">
                		<div class="col-md-4">
                			<form method="get" action="{{ route('colores.index') }}">
                	...
                	<div class="row justify-content-end mb-3 align-items-center">
                		...
                		<div class="col-md-2 offset-md-1 text-right">
                			<a class="btn btn-warning btn-sm" href="{{ route('colores.create') }}"><i class="fas fa-plus"></i> Nuevo</a>
                		</div>
                	</div>
						...
						<table class="table table-bordered table-sm">
						  	<thead>
						    	<tr>
						      		...
						      		<th scope="col">Color de Texto</th>
						  	...
						  	@foreach ($colores as $color)
						  		<tr>
					  				...
					  				<td class="text-center">
					  					<span class="badge" style="width:80px; background: {{ $color->bgColor }}; color: {{ $color->textColor }};">
					  						Color
					  					</span>
					  				</td>
									<td>{{ $color->bgColor }}</td>
									...
									<td class="text-center">
										<form id="estatus_delete" action="{{route('colores.destroy', $color->Id_Color)}}" method="post">
								            <a href="{{ route('colores.edit', ['id' => $color->Id_Color]) }}" class="btn btn-info btn-sm"><i class="far fa-edit"></i></a>
