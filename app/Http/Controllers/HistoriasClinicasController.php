...
class HistoriasClinicasController extends Controller
{
    ...
    public function print($id){
        ...
        PDF::setOptions(['debugCss' => true, 'debugLayout' => true, 'debugLayoutLines' => true, 'isHtml5ParserEnabled' => true, 'debugLayoutPaddingBox' => false, 'isFontSubsettingEnabled' => true]);
        $pdf->loadHTML($view);
