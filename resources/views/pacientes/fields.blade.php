<div class="container-fluid">
	<div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Pacientes &nbsp; • &nbsp; Formulario</div>
                <div class="card-body">
                	<div class="row mb-4 justify-content-center">
                		<div class="col-md-12">
                			<fieldset>
                				<legend>Instrucciones</legend>
                				<span>Ingresa la información correcta para añadir nuevo paciente al sistema.</span>
                			</fieldset>
                		</div>
                	</div>
                	<form @if(isset($paciente)) method="post" @else method="Post" @endif action="@if(isset($paciente)) {{ route('pacientes.update', $paciente->Id_Paciente) }} @else {{ route('pacientes.store') }} @endif ">
                		@csrf
	                		...
	                		<div class="col-md-9">
		                		<div class="row">
			                		...
			                		<div class="col-md-4 input-group input-group-sm mb-3">
			                			...
			                			<input id="nombre_paciente" class="form-control form-control-sm" type="text" name="nombre" placeholder="Nombre" @isset($paciente) value="{{ $paciente->Nombre }}" @endisset required>
			                		</div>
			                		<!-- Input Ap_Paterno -->
			                		<div class="col-md-4 input-group input-group-sm mb-3">
										<div class="input-group-prepend">
			                			...
			                			<input id="ap_paterno_paciente" class="form-control form-control-sm" type="text" name="ap_paterno" placeholder="Apellido Paterno" @isset($paciente) value="{{ $paciente->Ap_Paterno }}" @endisset required>
			                		</div>
			                		<!-- Input Ap_Materno -->
			                		<div class="col-md-4 input-group input-group-sm mb-3">
										<div class="input-group-prepend">
			                			...
			                			<input id="ap_materno_paciente" class="form-control form-control-sm" type="text" name="ap_materno" placeholder="Apellido Materno" @isset($paciente) value="{{ $paciente->Ap_Materno }}" @endisset>
			                		</div>
								</div>
								<div class="row">
									<!-- Input Edad -->
									<div class="col-md-3 input-group input-group-sm mb-3">
									  	...
									  	<input id="edad_paciente" class="form-control form-control-sm" type="text" name="edad" placeholder="Edad" @isset($paciente) value="{{ $paciente->Edad }}" @endisset required>
			                		...
			                		<div class="col-md-4 offset-md-1 input-group input-group-sm mb-3">
			                			...
			                			<input id="telefono_paciente" class="form-control form-control-sm" type="text" name="telefono" placeholder="Teléfono" @isset($paciente) value="{{ $paciente->Telefono }}" @endisset required>
			                		</div>
			                		<!-- Input Estatus -->
			                		<div class="col-md-4 input-group input-group-sm mb-3">
										<div class="input-group-prepend">
										...
										<select class="custom-select custom-select-sm" name="estatus" style="height: 31px" required>
											...
											@foreach ($estatus as $estatus)
												<option value="{{$estatus->Id_Estatus}}" @isset($paciente)@if ($paciente->Id_Estatus == $estatus->Id_Estatus)
													{{ 'selected'}}
												@endif
								...
								<div class="row">
			                		...
			                		<div class="col-md-8 input-group input-group-sm mb-3">
									  	...
									  	<textarea id="direccion_paciente" class="form-control" name="direccion" style="height: 80px; min-height: 80px; max-height: 80px;" placeholder="Dirección">@if(isset($paciente)){{ $paciente->Direccion }}@endif</textarea>
									</div>
								</div>
								<div class="row justify-content-center">
