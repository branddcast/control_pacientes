	...
	<div class="row">
        <div class="col-md-12">
            <div class="card shadow-sm">
                <div class="card-header bg-light shadow-sm">Especialidades</div>
                ...
                <div class="card-body">
                	...
                	<div class="row justify-content-end mb-3 align-items-center">
                		...
                		<div class="col-md-2 offset-md-1 text-right">
                			<a class="btn btn-warning btn-sm" href="{{ route('especialidades.create') }}"><i class="fas fa-plus"></i> Nuevo</a>
                		</div>
                	</div>
						  	...
						  	@foreach ($especialidades as $especialidad)
						  		<tr>
									...
									<td class="text-center">
										<form id="estatus_delete" action="{{route('especialidades.destroy', $especialidad->Id_Especialidad)}}" method="post">
								            <a href="{{ route('especialidades.edit', ['id' => $especialidad->Id_Especialidad]) }}" class="btn btn-info btn-sm"><i class="far fa-edit"></i></a>
